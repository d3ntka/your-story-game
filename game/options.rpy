...
define config.name = _("Your Story")
...
define config.steam_appid = 1247740

###########ZMIANA NA NOWY MODEL-BASED RENDERER
...
define config.mouse = { 'default' : [ ('gui/cursor.png', 3, 0)] }
...
define gui.about = _p("""{size=14}Red Forest by Arthur Vyncke | https://soundcloud.com/arthurvost
...
Emotionalism by Alexander Nakarada | https://www.serpentsoundstudios.com
Attribution 4.0 International (CC BY 4.0)
https://creativecommons.org/licenses/by/4.0/
...
The Old Tower Inn by Random Mind
Credit link: https://goo.gl/cN3oi3
Creative Commons: Attribution

Nowhere Land by Alexander Nakarada (www.serpentsoundstudios.com)
Licensed under Creative Commons BY Attribution 4.0 License
http://creativecommons.org/licenses/by/4.0/

Fantasy Ambience by Alexander Nakarada | https://www.serpentsoundstudios.com
Attribution 4.0 International (CC BY 4.0)
https://creativecommons.org/licenses/by/4.0/
...
define config.main_menu_music = "audio/music/main_menu_alexander_nakarada_battle_of_the_creek.mp3"
...
define config.save_directory = "YourStory-1579790397"
...
init python:
    ...
    build.classify('**/.afphoto', None)
    build.classify('*/testy.rpy', None)
    build.classify('*/testy.rpyc', None)
    build.classify('*/devconf.rpy', None)
    build.classify('*/devconf.rpyc', None)
    build.classify('*/proxy', None)
